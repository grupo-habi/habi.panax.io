            ...
            <col width="20" style="mso-width-source:userset;mso-width-alt:731;width:15pt" />
					...
					<thead>
						...
						<tr height="5" style="mso-height-source:userset;height:4.35pt">
							...
							<td colspan="10" class="xl7317904" dir="LTR" width="1300" style="width:976pt"> </td>
							<td class="xl1517904"></td>
						</tr>
					...
					<tbody>
						...
						<xsl:for-each select="//contratos/row">
							<tr height="38" style="height:28.5pt">
								...
								<xsl:variable name="facturas" select="//facturas/row[@cuenta=current()/@id][@tipo='cambio_nombre']"/>
						...
						<tfoot>
							<tr height="20" style="height:15.0pt">
								...
								<td colspan="2" class="xl6617904" dir="LTR" width="93" style="width:70pt">
									Total <xsl:value-of select="count(//contratos/row)"/>:
								</td>
								...
								<td class="xl7117904" dir="LTR" width="91" style="border-top:none;text-align:center;">
